...
func (c *referServiceClient) ReferOut(ctx context.Context, in *ReferOutRequest, opts ...grpc.CallOption) (*ReferOutResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v2.ReferService/ReferOut", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *referServiceClient) Visit(ctx context.Context, in *ReferOutRequest, opts ...grpc.CallOption) (*ReferVisitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v2.ReferService/Visit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReferService_ReferOut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v2.ReferService/ReferOut",
	}
...
func _ReferService_Visit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v2.ReferService/Visit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
